...
import TileViewPostedProjectsClass from './TileViewPostedProjects';
...
/*  handleRadioChange(event){
  ...
  handleSwitchLabelChange=event=>{
    ...
    this.setState({
      switchLabelState:event.target.checked
    })
  }
  render() {
    ...
    <React.Fragment>
      ...
      {<FormControlLabel style={{float:"right"}}
          control={
            ...
            checked={this.state.switchLabelState}
          ...
          label={this.state.switchLabelState ? "Buyer":"Vendor"}
        />}
      </Grid> */}
      </Grid>
      ...
      <TileViewPostedProjectsClass classes={classes}/>
      </Paper>  
      {/* End hero unit */}
     {/* Footer */}
