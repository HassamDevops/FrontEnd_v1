...
console.log("Key is : " + name + " and Value is : " + value);
  ...
  .then(
    ...
    .then(
      response=>{
        ...
        console.log('bid data response is: ',response.data)
        this.setState({
          bidderinputs:response.data.bids,
          error:""
        })
      })
      .catch(error=>{
  ...
  render() {
    ...
    const { showDButton, input,bidderinputs, errorMsg } = this.state
    return (
          ...
          {input.name}
                  ...
                  <div className={classes.box}>
                    ...
                    {/* <Paper> */}
                      ...
                      </IconButton>       {/*Show this icon only to the user who posted the project */}
...
{/* Project Title */}
                            ...
                            <Button
                              ...
                              color="primary"
                              style={{
                                float: 'left', backgroundColor: '#33ab9f',
                                '&:hover': {
                                  backgroundColor: '#009688',
                                },
                              }}
       ...
       {bidderinputs.length>0 && <Typography component="h6" variant="h6" align="left" color="textPrimary" gutterBottom>
          Submitted Proposals:
        </Typography>
        }
        {bidderinputs.length ?bidderinputs.map(inp =>
<Paper elevation={1}  key={inp} style={{marginBottom:10}}>
...
//   }}
  >
  {inp}
  {/* onClick={this.handleClick(inp)} */}
</Typography>
<IconButton onClick={()=>this.handleClick(inp)} >
<GetAppIcon />
</IconButton>
</Paper>
    ) : null}
