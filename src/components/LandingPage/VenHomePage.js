...
import TileViewBoughtProjects from './TileViewBoughtProjects';
...
class VenHomePageClass extends React.Component {
  constructor(props) {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <TileViewBoughtProjects classes={classes} />
        </Paper>
        {/* End hero unit */}
        {/* Footer */}
...
export default () => {
  ...
  return (
    <VenHomePageClass classes={classes} />
  )
}